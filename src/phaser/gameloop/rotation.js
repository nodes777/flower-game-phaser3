...
export function beeFrameRotate(target, game, theta) {
	...
	// need to account for negative angles
	if (game.bee.angleForFrameDeg <= 0) {
		game.bee.setFrame(4);
	} else if (game.bee.angleForFrameDeg <= 22.5) {
		game.bee.setFrame(5);
	} else if (game.bee.angleForFrameDeg <= 45) {
		game.bee.setFrame(6);
	} else if (game.bee.angleForFrameDeg <= 67.5) {
		game.bee.setFrame(7);
	} else if (game.bee.angleForFrameDeg <= 90) {
		game.bee.setFrame(8);
	} else if (game.bee.angleForFrameDeg <= 112.5) {
		game.bee.setFrame(9);
	} else if (game.bee.angleForFrameDeg <= 135) {
		game.bee.setFrame(10);
	} else if (game.bee.angleForFrameDeg <= 157.5) {
		game.bee.setFrame(11);
	} else if (game.bee.angleForFrameDeg <= 180) {
		game.bee.setFrame(12);
	} else if (game.bee.angleForFrameDeg <= 202.5) {
		game.bee.setFrame(13);
	} else if (game.bee.angleForFrameDeg <= 225) {
		game.bee.setFrame(14);
	} else if (game.bee.angleForFrameDeg <= 247.5) {
		game.bee.setFrame(15);
	} else if (game.bee.angleForFrameDeg <= 270) {
		game.bee.setFrame(0);
	} else if (game.bee.angleForFrameDeg <= 292.5) {
		game.bee.setFrame(1);
	} else if (game.bee.angleForFrameDeg <= 315) {
		game.bee.setFrame(2);
	} else if (game.bee.angleForFrameDeg <= 337.5) {
		game.bee.setFrame(3);
	}
